...
bool USER_USB_CALLBACK_EVENT_HANDLER(USB_EVENT event, void *pdata, uint16_t size)
{
    switch( (int) event )
    {
        ...
        case EVENT_SUSPEND:
            ...
            // Not used actually on ALFOSo
            // ConfigSystemState(SYSTEM_STATE_USB_SUSPEND);
            break;
        ...
        case EVENT_RESUME:
            ...
            //preceding ConfigSystemState(SYSTEM_STATE_USB_SUSPEND) call at the start
            //of the suspend condition.
            // Not used actually on ALFOSo
            // ConfigSystemState(SYSTEM_STATE_USB_RESUME);
            break;
            
        case EVENT_CONFIGURED:
            // When the device is configured, we can (re)initialize the system.
            CDCInitEP();
            // Update state
            ConfigSystemState(SYSTEM_STATE_USB_CONFIGURED);
            break;
