...
${OBJECTDIR}/ccp/CCPLib.p1: ccp/CCPLib.c  nbproject/Makefile-${CND_CONF}.mk 
	...
	${MP_CC} $(MP_EXTRA_CC_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -c  -D__DEBUG=1  -mdebugger=pickit3   -mdfp="${DFP_DIR}/xc8"  -fno-short-double -fno-short-float -memi=wordwrite -O0 -fasmfile -maddrqual=ignore -xassembler-with-cpp -I"globals" -I"system" -I"usb" -I"spi" -I"spi/MCP42XXX" -I"spi/MCP425X" -I"spi/MCP23S08" -I"spi/MCP23S08/LCD44780_MCP23S08" -I"spi/MCP23S17" -I"i2c" -I"i2c/PCF8574" -I"frequency" -I"ccp" -I"utilities" -mwarn=-3 -Wa,-a -DXPRJ_default=$(CND_CONF)  -msummary=-psect,-class,+mem,-hex,-file  -ginhx32 -Wl,--data-init -mno-keep-startup -mno-download -mdefault-config-bits $(COMPARISON_BUILD)  -std=c99 -gdwarf-3 -mstack=compiled:auto:auto:auto     -o ${OBJECTDIR}/ccp/CCPLib.p1 ccp/CCPLib.c 
...
${OBJECTDIR}/frequency/Frequency.p1: frequency/Frequency.c  nbproject/Makefile-${CND_CONF}.mk 
	@${MKDIR} "${OBJECTDIR}/frequency" 
	@${RM} ${OBJECTDIR}/frequency/Frequency.p1.d 
	@${RM} ${OBJECTDIR}/frequency/Frequency.p1 
	${MP_CC} $(MP_EXTRA_CC_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -c  -D__DEBUG=1  -mdebugger=pickit3   -mdfp="${DFP_DIR}/xc8"  -fno-short-double -fno-short-float -memi=wordwrite -O0 -fasmfile -maddrqual=ignore -xassembler-with-cpp -I"globals" -I"system" -I"usb" -I"spi" -I"spi/MCP42XXX" -I"spi/MCP425X" -I"spi/MCP23S08" -I"spi/MCP23S08/LCD44780_MCP23S08" -I"spi/MCP23S17" -I"i2c" -I"i2c/PCF8574" -I"frequency" -I"ccp" -I"utilities" -mwarn=-3 -Wa,-a -DXPRJ_default=$(CND_CONF)  -msummary=-psect,-class,+mem,-hex,-file  -ginhx32 -Wl,--data-init -mno-keep-startup -mno-download -mdefault-config-bits $(COMPARISON_BUILD)  -std=c99 -gdwarf-3 -mstack=compiled:auto:auto:auto     -o ${OBJECTDIR}/frequency/Frequency.p1 frequency/Frequency.c 
	@-${MV} ${OBJECTDIR}/frequency/Frequency.d ${OBJECTDIR}/frequency/Frequency.p1.d 
	@${FIXDEPS} ${OBJECTDIR}/frequency/Frequency.p1.d $(SILENT) -rsi ${MP_CC_DIR}../  
